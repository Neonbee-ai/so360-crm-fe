            ...
            <div className="flex flex-col md:flex-row gap-4 mb-6">
                <div className="relative flex-1">
                    ...
                    <input
                        ...
                        className="w-full bg-slate-950 border border-slate-800 text-slate-200 text-sm pl-10 pr-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all"
                    />
                </div>
